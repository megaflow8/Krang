...
RDEPEND="
	...
	>=x11-libs/gdk-pixbuf-2.44.0:2
	>=x11-libs/pango-1.58.0
	>=x11-libs/gtk+-3.24.50:3[cups?]
	>=gui-libs/gtk-4.23.0:4[cups?]
	>=gui-libs/libadwaita-1.10.0:1
	>=app-accessibility/at-spi2-core-2.62.0:2
	>=media-libs/glycin-loaders-2.2.0
	>=gnome-base/librsvg-2.63.0
	>=gnome-base/gnome-desktop-51.0:4

	>=gnome-base/gvfs-1.62.0
	>=gnome-base/dconf-0.51.0
